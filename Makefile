...
hello_asyncify.wasm: inc/fiber.h src/asyncify/asyncify_impl.c examples/hello.c
	...
	$(ASYNCIFY) hello_asyncfiy.pre.wasm -o $@
	chmod +x $@
...
hello_asyncify_switch.wasm: inc/fiber_switch.h src/asyncify/asyncify_switch_impl.c examples/hello_switch.c
	...
	$(ASYNCIFY) hello_asyncfiy_switch.pre.wasm -o $@
	chmod +x $@
...
itersum_switch_asyncify.wasm: inc/fiber_switch.h src/asyncify/asyncify_switch_impl.c examples/itersum_switch.c
	...
	$(ASYNCIFY) itersum_switch_asyncfiy.pre.wasm -o $@
	chmod +x $@

itersum_switch_wasmfx.wasm: inc/fiber_switch.h fiber_switch_wasmfx_imports.wasm src/wasmfx/wasmfx_switch_impl.c examples/itersum_switch.c
	...
	$(WASM_MERGE) fiber_switch_wasmfx_imports.wasm "fiber_switch_wasmfx_imports" itersum_switch_wasmfx.pre.wasm "main" -o $@
	chmod +x $@
...
treesum_switch_asyncify.wasm: inc/fiber_switch.h src/asyncify/asyncify_switch_impl.c examples/treesum_switch.c
	...
	$(ASYNCIFY) treesum_switch_asyncfiy.pre.wasm -o $@
	chmod +x $@

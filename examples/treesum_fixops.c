...
int main(int argc, char** argv) {
  ...
  int iters = 32*1024*1024 / pow(2, depth);
  printf("Running %d iters to get %d total ops with depth %d\n", iters, (int)(iters * pow(2, depth)), depth);
  node_t *tree = build_tree((int32_t)depth, 0);
